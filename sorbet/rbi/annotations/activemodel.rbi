...
class ActiveModel::Errors
  Elem = type_member { { fixed: ActiveModel::Errors } }

  sig { params(attribute: T.any(Symbol, String)).returns(T::Array[String]) }
  def [](attribute); end

  sig { params(attribute: T.any(Symbol, String), type: T.untyped, options: T.untyped).returns(ActiveModel::Errors) }
  ...
  sig { returns(T::Hash[Symbol, T::Array[ActiveModel::Errors]]) }
  def group_by_attribute; end

  sig { params(attribute: T.any(Symbol, String)).returns(T::Boolean) }
  def has_key?(attribute); end

  sig { params(error: ActiveModel::Errors, override_options: T.untyped).returns(T::Array[ActiveModel::Errors]) }
