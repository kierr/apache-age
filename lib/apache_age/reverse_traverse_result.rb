...
module ApacheAge
  ...
  class ReverseTraverseResult
    ...
    sig { params(source_object_id: String, target_object_id: String, source_object_type: String).void }
    def initialize(source_object_id:, target_object_id:, source_object_type:)
    ...
    def [](key)
      ...
      when :source_object_type then @source_object_type
      end
    end
  end
end
