...
Gem::Specification.new do |spec|
  spec.name          = 'apache-age'
  spec.version       = ApacheAge::VERSION
  spec.authors       = ['Kier']
  spec.email         = ['']

  spec.summary       = 'Apache AGE graph database driver for Ruby'
  spec.description   = <<~DESC
    A Ruby driver for Apache AGE, the PostgreSQL extension for graph databases.
    Provides agtype parsing, graph lifecycle management, Cypher query execution
    with parameterized statements, and Vertex/Edge/Path domain models — matching
    the API surface of the official Python, Node.js, Go, and JDBC drivers.
  DESC
